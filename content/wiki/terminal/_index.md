...
{{% blockquote type="tip" %}}
Desde la nueva versión de macOS Sequoia tiene por defecto `zsh`, pero sigue estando disponible el `bash` y puedes habilitarla por defecto en la configuración del terminal.
{{% /blockquote %}}
