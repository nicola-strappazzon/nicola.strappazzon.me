...
El CI 4052 permitira usar un pin de control XX para redirigir la entrada TX y RX del CH340, al circuito de UPDI o a los pines del UART del MCU.
...
Lo que pasará es que al grabar en el MCU se pondrá el pin DTR en LOW (0v) y el CI 4052 redirige al circuito que usará el UPDI. Al terminar de grabar el pin DTR volvera a su estado inicial en HIGH (5v) y se podrá usar de comunicación Serial.
